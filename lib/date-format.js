...
export function applyDateFormatClient(prefs) {
  ...
  // Notify in-page providers (DateFormatProvider lives in the persistent root
  // layout) so already-open screens reformat immediately, without a reload.
  if (typeof window !== 'undefined') {
    window.dispatchEvent(
      new CustomEvent('mosaic:datefmt', {
        detail: {
